...
# Comment out opuslib or pyflac depending on the codec you want to use
...
if __name__ == "__main__":
    # Setup for OPUS codec, call setup-OPUS.py
    ...
    is_encode, audio_data, audio_frame_rate, bin_data = inputSanityCheck(
        encode=args.encode, decode=args.decode
    )
